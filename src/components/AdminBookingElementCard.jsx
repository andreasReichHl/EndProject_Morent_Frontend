...
export default function AdminBookingElementCard({ booking }) {
              ...
              <div className="bg-white px-6 py-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out border border-gray-200 mb-4">
                ...
                <button
                  onClick={(event) => {
                    ...
                    navigate("/admin-panel/handover", {
                      state: { bookingId: booking.bookingId },
                    });
                  }}
                  className="px-4 py-2 bg-blue-700 text-white rounded-lg hover:bg-blue-300 transition duration-200 ease-in-out"
                >
                  HandOver
                </button>
              </div>
