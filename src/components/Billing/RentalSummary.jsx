                    ...
                    <div>
                        ...
                        <div className="p-6 rounded-md space-y-4">
                            ...
                            <ul className="space-y-2 list-disc list-inside">
                                ...
                                <li>
                                    {totalDays * 500} km sind inklusive, danach
                                    kostet jeder zusätzliche Kilometer{" "}
                                    <strong>0,36 €</strong>
                                </li>
                            </ul>
                            <div className="mt-4">
                                <p>
                                    <strong>Buchungsoption:</strong> Flexibel
                                    bleiben - Beim Abholen zahlen, jederzeit vor
                                    der Abholzeit kostenlos stornierbar und
                                    umbuchbar
                                </p>
                            </div>
                        </div>
